...
group "default" {
  targets = ["base", "awk", "ballerina", "bc", "dc", "build-base", "3var", "adjust", "aheui", "alphabeta", "apl", "axo", "bash-pure", "bash-busybox", "basic-freebasic", "beatnik", "befunge93", "befunge98", "seed", "blc", "braille", "c-gcc", "clisp-sbcl", "cobol", "codemania", "cubically", "cyclicbrainfuck", "dis", "dotnet-base", "csharp-dotnet", "fsharp-dotnet", "function2d", "visualbasic-dotnet", "doubleplusungood", "fetlang", "fish-shell-pure", "fortran", "glass", "goruby", "hanoi_stack", "intercal", "lazyk", "llvm-ir", "lolcode", "make", "malbolge", "minus", "multi-reader", "olang", "osecpu", "osecpu-aska", "piet", "python1", "python2", "aubergine", "brainfuck-esotope", "fernando", "gs2", "haystack", "i4004asm", "logicode", "minimal2d", "path", "recurse", "snusp", "stuck", "suzy", "unicat", "unreadable", "zombie", "qi", "r-language", "rail", "rapira", "rescript", "ring", "ruby", "alice", "arithmetic", "brainfuck-esomer", "copos-rb", "cy", "golfish", "golfscript", "hexagony", "labyrinth", "pxem", "pyramid-scheme", "reversed-c", "ruby-trunk", "stackcats", "standback", "starry", "typhon", "vim", "autovim", "v-vim", "wake", "ruby1", "grass", "modanshogi", "ppap", "rust", "sceql", "simula", "snobol", "snowman", "spl", "streem", "taxi", "tcl", "unlambda", "verilog", "vlang", "wat", "wierd", "wordcpu", "wren", "zsh-pure", "cmd", "csharp", "bubble-sort", "classic-music-theory", "produire", "z80", "erlang", "elixir", "05ab1e", "ffmpeg", "gnuplot", "golang", "braintwist", "tsp", "haskell", "whitespace", "java", "arnoidc", "cjam", "convex", "evil", "floater", "js-rhino", "kotlin", "vyxal", "whenever", "xslt", "jq", "lua", "rprogn", "m4", "node", "beam", "calc", "canvas", "compile-time-typescript", "cubix", "emojifunge", "floating", "hakerh-base", "encapsulation", "functional", "seclusion", "serenity", "transceternal", "htms", "japt", "maybelater", "nadesiko", "nuts", "qlb", "stop", "tetris", "unicue", "wenyan", "wysiscript", "ocaml", "coq", "octave", "matl", "perl", "element", "slashes", "perl6", "php", "irc", "python3", "2sable", "arcyou", "asciidots", "backhand", "bots", "cardinal", "chelang", "emoji", "exchangeif", "ezhil", "ffb", "fish", "gaia", "hbcht", "hypertorus", "iwashi", "jelly", "jellyfish", "mao", "mines", "picfunge", "pure-folders", "triangularity", "ubergenes", "width", "zucchini", "racket", "sed", "zig", "brainfuck-bfi", "ubuntu-base", "abc", "ada", "apache2-rewrite", "cpp-clang", "cpp-compile-time-clang", "crystal", "csound", "d-dmd", "d-gdc", "ed", "egison", "emojicode", "fugue", "imagemagick", "moo", "nim-lang", "perl1", "powershell", "sqlite3", "swift", "terra", "tex", "bibtex", "x86asm-nasm"]
}
