...
* [`esolang/base`](https://hub.docker.com/r/esolang/base/)
    ...
    * [`esolang/build-base`](https://hub.docker.com/r/esolang/build-base/)
        ...
        * [`esolang/goruby`](https://hub.docker.com/r/esolang/goruby/): [goruby](https://github.com/ruby/ruby/blob/master/man/goruby.1)
        ...
        * [`esolang/verilog`](https://hub.docker.com/r/esolang/verilog/): [Verilog (Icarus Verilog)](https://steveicarus.github.io/iverilog/)
    ...
    * [`esolang/node`](https://hub.docker.com/r/esolang/node/): [Node.js](https://nodejs.org/)
        ...
        * [`esolang/calc`](https://hub.docker.com/r/esolang/calc/): [LibreOffice Calc](https://www.libreoffice.org/)
        ...
        * [`esolang/tetris`](https://hub.docker.com/r/esolang/tetris/): [Tetris](https://github.com/Muratam/tetris-esolang)
...
* [`esolang/ubuntu-base`](https://hub.docker.com/r/esolang/ubuntu-base/)
    ...
    * [`esolang/tex`](https://hub.docker.com/r/esolang/tex/): [TeX (plain)](http://texdoc.net/texmf-dist/doc/plain/texbytopic/TeXbyTopic.pdf)
        * [`esolang/bibtex`](https://hub.docker.com/r/esolang/bibtex/): [BiBTeX](https://ctan.tikz.jp/info/bibtex/tamethebeast/ttb_en.pdf)
